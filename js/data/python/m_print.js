    ...
    tasks: [
...

      {
        ...
        desc: `
          ...
          <div class="task-note">
            <b>Важливо:</b> Зверни особливу увагу на тире та пробіли навколо нього. Система перевіряє кожен символ, тому копіюй уважно.
          </div>
        `,
...
// ==========================================
      ...
      // Цей рівень вчить не просто друкувати текст,
      // а керувати тим, ЯК саме він вигляє в терміналі:
      // лапки, переноси, табуляція, блоки тексту, f-рядки й комбінування всього разом.
      // ==========================================

      {
        ...
        theory: `
          ...
          <div class="theory-alert theory-alert-info">
            💡 <b style="color: #0ea5e9;">Пам'ятай:</b> Слеш <code>\\</code> не друкується на екрані! Він лише "захищає" наступний символ.
          </div>
        `,
        desc: `Напиши програму, яка виводить точнісінько такий текст:<br><br>
        <code style="color: #f59e0b; font-size: 16px;">Книга "Гаррі Поттер"</code>
        
        <div class="task-condition">
          <b style="color: #8b5cf6;">Умова:</b> Напиши весь текст у подвійних лапках. Перед внутрішніми лапками (навколо назви книги) обов'язково постав символ зворотного слеша <code style="color: #0ea5e9;">\\</code>.
        </div>`,
...

      {
        ...
        `,
        desc: `Напиши програму, яка виводить рядок:<br><br>
        <code style="color: #f59e0b; font-size: 16px;">It's a "magic" trick</code>
        
        <div class="task-condition">
          <b style="color: #8b5cf6;">Умова:</b> Використай правильні зовнішні лапки, щоб не довелося екранувати внутрішні (або навпаки, якщо хочеш потренуватися з екрануванням).
        </div>`,
        hint: `Тут є і апостроф, і подвійні лапки. Обери такі зовнішні лапки, щоб конфлікт був мінімальний.`,
...

      {
        ...
        `,
        desc: `Напиши програму, яка виводить слова (кожне з нового рядка):<br><br>
        <code style="color: #f59e0b; font-size: 16px;">Один<br>Два<br>Три</code>
        
        <div class="task-condition">
          <b style="color: #8b5cf6;">Умова:</b> Використовуючи лише ОДИН <code style="color: #0ea5e9;">print()</code>, напиши ці слова одним суцільним текстом в одних лапках. Замість пробілів між словами встав спецсимвол <code style="color: #0ea5e9;">\\n</code>.
        </div>`,
        hint: `Усе має бути в одному рядку коду. Для переходу вниз використай спецсимвол \\n без зайвих пробілів біля нього.`,
        expected: `Один\nДва\nТри`,
        tests: [
...

      {
        ...
        theory: `
          ...
          <p>Символ <b style="color: #3b82f6;">\\t</b> (від англ. <i>tab</i>) робить великий відступ-стрибок. Це швидкий спосіб розсунути слова на широку відстань і зробити колонки більш охайними.</p>
          <p><b>Приклад:</b></p>
          <div class="code-box">print("Ім'я\\tВік\\tКлас")</div>
          <p><b>Результат у терміналі:</b></p>
          <div class="output-box">Ім'я    Вік    Клас</div>
        `,
        desc: `Напиши програму, яка виводить текст:<br><br>
        <code style="color: #f59e0b; font-size: 16px;">Гравець&nbsp;&nbsp;&nbsp;&nbsp;Рівень&nbsp;&nbsp;&nbsp;&nbsp;Бал</code>
        
        <div class="task-condition">
          <b style="color: #8b5cf6;">Умова:</b> Замість пробілів між словами використай спецсимвол табуляції <code style="color: #0ea5e9;">\\t</code>.
        </div>`,
        hint: `У тебе має бути один рядок тексту, а великі відступи між словами зробить спецсимвол табуляції.`,
...

      {
        ...
        `,
        desc: `Намалюй поле для хрестиків-нуликів розміром 2х2:<br>
<pre style="color: #f59e0b; font-size: 16px;">X	O
O	X</pre>

        <div class="task-condition">
          <b style="color: #8b5cf6;">Умова:</b> Використай ОДИН <code style="color: #0ea5e9;">print()</code>. Між літерами в одному рядку має бути табуляція <code style="color: #0ea5e9;">\\t</code>, а між рядками — перенос <code style="color: #0ea5e9;">\\n</code>. Жодних пробілів!
        </div>`,
...
А це другий.
      А це третій з відступом!""")</div>
        ...
        `,
        desc: `Намалюй ASCII-квадрат із зірочок:<br>
<pre style="color: #f59e0b; font-size: 16px;">***
* *
***</pre>

        <div class="task-condition">
          <b style="color: #8b5cf6;">Умова:</b> Використай потрійні лапки <code style="color: #0ea5e9;">"""</code> і просто натискай клавішу Enter прямо в коді для переносу рядків. Не використовуй <code style="color: #0ea5e9;">\\n</code>.
        </div>`,
        hint: `Використай потрійні лапки й стеж, щоб на початку рядків не з’явилися зайві пробіли.`,
        expected: `***\n* *\n***`,
        tests: [
...

      {
        ...
        `,
        desc: `Надрукуй суцільну лінію з <b>20 символів решітки</b>:<br><br>
        <code style="color: #f59e0b; font-size: 16px;">####################</code>
        
        <div class="task-condition">
          <b style="color: #8b5cf6;">Умова:</b> Використай множення тексту на число <code style="color: #0ea5e9;">*</code>. Не пиши 20 решіток вручну!
        </div>`,
        hint: `Створи лінію через множення одного символу на число.`,
        expected: `####################`,
        tests: [
...

      {
        ...
        `,
        desc: `Надрукуй рядок:<br><br>
        <code style="color: #f59e0b; font-size: 16px;">Рахунок: 200 балів</code>
        
        <div class="task-condition">
          <b style="color: #8b5cf6;">Умова:</b> Використай <b>f-рядок</b>. Python сам має помножити <code style="color: #0ea5e9;">100 * 2</code> всередині фігурних дужок і вивести результат 200.
        </div>`,
        hint: `Тут має бути саме f-рядок: текст зовні, а обчислення — всередині фігурних дужок.`,
...

      {
        ...
        kind: "practice",
        difficulty: "Middle",
        desc: `Виведи текст:<br><br>
        <code style="color: #f59e0b; font-size: 16px;">Площа кімнати 5х4 дорівнює 20 кв.м.</code>
        
        <div class="task-condition">
          <b style="color: #8b5cf6;">Умова:</b> Число 20 має бути обчислене всередині f-рядка як математична дія <code style="color: #0ea5e9;">5 * 4</code>. Не пиши число 20 вручну!
        </div>`,
        hint: `Нехай Python сам порахує 5 * 4 всередині f-рядка.`,
...

      {
        ...
        `,
        desc: `Надрукуй статистику:<br><br>
        <code style="color: #f59e0b; font-size: 16px;">Всього: 100, Продано: 20, Залишок: 80</code>
        
        <div class="task-condition">
          <b style="color: #8b5cf6;">Умова:</b> Число 80 має обчислюватись як <code style="color: #0ea5e9;">100 - 20</code> прямо в дужках <code style="color: #0ea5e9;">{}</code>.
        </div>`,
        hint: `Число 80 тут повинно з’явитися з обчислення, а не бути надрукованим готовим.`,
...

      {
        ...
        `,
        desc: `Використовуючи ОДИН <b>f-рядок</b>, надрукуй два рядки (через <code style="color: #0ea5e9;">\\n</code>):<br>
<pre style="color: #f59e0b; font-size: 16px;">Base: 50
Buff: 60</pre>

        <div class="task-condition">
          <b style="color: #8b5cf6;">Умова:</b> Число 60 обчисли в фігурних дужках як <code style="color: #0ea5e9;">50 + 10</code>.
        </div>`,
...

      {
        ...
        theory: `
          ...
          <div class="theory-alert theory-alert-warn">
            💡 <b style="color: #f59e0b;">Увага:</b> Якщо f-рядок зовні має подвійні лапки, всередині фігурних дужок зручно використовувати одинарні.
          </div>
        `,
        desc: `Виведи текст:<br><br>
        <code style="color: #f59e0b; font-size: 16px;">Loading: ........</code>
        
        <div class="task-condition">
          <b style="color: #8b5cf6;">Умова:</b> Створи 8 крапок шляхом множення тексту <code style="color: #0ea5e9;">'.' * 8</code> всередині фігурних дужок f-рядка.
        </div>`,
...

      {
        ...
        `,
        desc: `Виведи точнісінько такий лог:<br>
<pre style="color: #f59e0b; font-size: 16px;">ERROR	404
********************
System	Down</pre>

        <div class="task-condition">
          <b style="color: #8b5cf6;">Умови:</b><br>
          1) Використай ОДИН <code style="color: #0ea5e9;">print()</code>.<br>
          2) Між словами ERROR і 404 (а також System і Down) — табуляція <code style="color: #0ea5e9;">\\t</code>.<br>
          3) Рядок із зірочок отримай множенням: <code style="color: #0ea5e9;">"*" * 20</code>.<br>
          4) Використай параметр <code style="color: #0ea5e9;">sep="\\n"</code> для розбиття на рядки.
        </div>`,
        hint: `Збери три частини логу в одному print(): верхній рядок, лінію-розділювач і нижній рядок.`,
        expected: `ERROR\t404\n********************\nSystem\tDown`,
        tests: [
...

      {
        ...
        `,
        desc: `Виведи такий текст:<br><br>
        <code style="color: #f59e0b; font-size: 16px;">Удар! База: 15, Критичний: 30, Залишок HP: 70</code>
        ...
        hint: `У цьому рядку важливо не просто вивести числа, а обчислити їх прямо всередині f-рядка.`,
...
====================</pre>
        ...
        hint: `Середній рядок має містити подвійні лапки як частину тексту.`,
        expected: `====================\n"Python Master"\n====================`,
        tests: [
      ...
      // ===============================
      {
        ...
        `,
        desc: `Виведи <b>точно</b> таку таблицю:<br>
<pre style="color: #f59e0b; font-size: 16px;">************
Name	"Neo"
XP	150
************</pre>
        ...
        <div class="task-condition">
          <b style="color: #8b5cf6;">Умови місії:</b><br>
          1) Використай <b>ОДИН</b> <code style="color: #0ea5e9;">print()</code> та <b>ОДИН f-рядок</b>.<br>
          2) Рамка зверху і знизу — це множення <code style="color: #0ea5e9;">'*' * 12</code>, записане всередині фігурних дужок.<br>
          3) Слово Neo має бути в подвійних лапках.<br>
          ...
          6) Число 150 має бути обчислене в дужках як <code style="color: #0ea5e9;">100 + 50</code>.
        </div>`,
        hint: `Збери все разом: один f-рядок, рамка з множення, \\n, \\t, лапки в тексті й одне обчислення.`,
        expected: `************\nName\t"Neo"\nXP\t150\n************`,
        tests: [
...
// ==========================================
...

      {
        ...
        theory: `
          ...
          <p>Усередині f-рядків можна не лише обчислювати математику, а й <b style="color: #3b82f6;">вирівнювати текст</b>, ніби в таблиці. Для цього після значення ставиться двокрапка <code>:</code> і спеціальний символ.</p>
          
          <ul style="padding-left: 20px; line-height: 1.6;">
            <li><code>:^10</code> — вирівняти по <b>центру</b> на ширину 10 символів.</li>
          </ul>
        ...
        `,
        desc: `Напиши програму, яка створює красивий заголовок:<br><br>
        <code style="color: #f59e0b; font-size: 16px;">==== MENU ====</code>
        
        <div class="task-condition">
          <b style="color: #8b5cf6;">Умова:</b> Використай f-рядок. Слово <code style="color: #0ea5e9;">' MENU '</code> (з пробілами по краях) має бути вирівняне по центру на загальну ширину 14 символів, а порожнеча заповнена знаками дорівнює <code style="color: #0ea5e9;">=</code>.
        </div>`,
...

      {
        ...
        `,
        desc: `Надрукуй табличку рейтингу (один рядок):<br><br>
        <code style="color: #f59e0b; font-size: 16px;">Neo       |  999</code>
        
        <div class="task-condition">
          <b style="color: #8b5cf6;">Умова:</b> Використай f-рядок. Ім'я <code style="color: #0ea5e9;">'Neo'</code> має бути притиснуте ліворуч на ширину 10 символів, потім іде символ <code style="color: #0ea5e9;">|</code>, а число <code style="color: #0ea5e9;">999</code> притиснуте праворуч на ширину 5 символів.
        </div>`,
...

      {
        ...
        `,
        desc: `Надрукуй результат обчислення у красивому фінансовому форматі:<br><br>
        <code style="color: #f59e0b; font-size: 16px;">Баланс: 2,500.50 ₴</code>
        
        <div class="task-condition">
          <b style="color: #8b5cf6;">Умова:</b> Баланс має бути отриманий з числа <code style="color: #0ea5e9;">2500.5</code>. Використай f-рядок і формат <code style="color: #0ea5e9;">:,.2f</code>, щоб Python сам додав кому для тисяч і нуль у кінці.
        </div>`,
...

      {
        ...
        theory: `
          ...
          <div class="theory-alert theory-alert-warn">
            💡 <b style="color: #f59e0b;">Увага:</b> <code style="color: #0ea5e9;">.1%</code> означає "один знак після коми". Якщо написати просто <code style="color: #0ea5e9;">.0%</code>, дробової частини не буде взагалі.
          </div>
        `,
        desc: `Обчисли та виведи відсоток виконання місії:<br><br>
        <code style="color: #f59e0b; font-size: 16px;">Прогрес: 87.5%</code>
        
        <div class="task-condition">
          <b style="color: #8b5cf6;">Умова:</b> Всередині f-рядка поділи <code style="color: #0ea5e9;">7 / 8</code> та відформатуй результат як відсоток з одним знаком після крапки <code style="color: #0ea5e9;">:.1%</code>.
        </div>`,
...

      {
        ...
        `,
        desc: `Намалюй динамічну рамку для слова <code>BOSS</code>:<br><br>
        <code style="color: #f59e0b; font-size: 16px;">***BOSS***</code>
        
        <div class="task-condition">
          <b style="color: #8b5cf6;">Умова:</b> Використай вирівнювання по центру <code style="color: #0ea5e9;">^</code> із заповнювачем <code style="color: #0ea5e9;">*</code>. Але ширину (кількість символів) задай через математичне обчислення <code style="color: #0ea5e9;">{5 * 2}</code> прямо в налаштуваннях формату.
        </div>`,
...

      {
        ...
        `,
        desc: `Згенеруй системний лог:<br><br>
        <code style="color: #f59e0b; font-size: 16px;">Mem: 0x00ff, Mask: 1010</code>
        
        <div class="task-condition">
          <b style="color: #8b5cf6;">Умова:</b> Число <code style="color: #0ea5e9;">255</code> має бути виведене у форматі hex з нулями на початку (<code style="color: #0ea5e9;">:04x</code>), а число <code style="color: #0ea5e9;">10</code> — у двійковому форматі (<code style="color: #0ea5e9;">:b</code>). Не пиши ці відповіді вручну!
        </div>`,
...

      {
        ...
        `,
        desc: `Надрукуй шлях до системної папки без жодного екранування:<br><br>
        <code style="color: #f59e0b; font-size: 16px;">C:\\ninja\\tricks\\new_file.py</code>
        
        <div class="task-condition">
          <b style="color: #8b5cf6;">Умова:</b> Не використовуй подвійні слеші <code style="color: #0ea5e9;">\\\\</code>. Просто додай префікс <code style="color: #0ea5e9;">r</code> перед рядком.
        </div>`,
...

      {
        ...
        `,
        desc: `Імітуй завантаження за допомогою двох команд print():<br><br>
        <code style="color: #f59e0b; font-size: 16px;">Success!</code>
        
        <div class="task-condition">
          <b style="color: #8b5cf6;">Умова:</b> Перший <code style="color: #0ea5e9;">print()</code> має вивести <code>Wait...</code> з параметром <code style="color: #0ea5e9;">end=""</code>. Другий <code style="color: #0ea5e9;">print()</code> має містити символ повернення каретки <code style="color: #0ea5e9;">\\r</code> і текст <code>Success!</code>.
        </div>`,
...
""")</div>
        `,
        desc: `Використовуючи ОДИН <b>f-рядок з потрійними лапками</b>, виведи такий віршик:<br>
<pre style="color: #f59e0b; font-size: 16px;">2 плюс 2
дорівнює 4</pre>

        <div class="task-condition">
          <b style="color: #8b5cf6;">Умова:</b> Ти не маєш використовувати <code style="color: #0ea5e9;">\\n</code>. Перенос рядка зроби просто клавішею Enter. Число 4 має бути обчислене в дужках <code style="color: #0ea5e9;">{2+2}</code>.
        </div>`,
...

      {
        ...
        `,
        desc: `Напиши програму, яка виводить ідентифікатор користувача:<br><br>
        <code style="color: #f59e0b; font-size: 16px;">Твій ID: 00007</code>
        
        <div class="task-condition">
          <b style="color: #8b5cf6;">Умова:</b> Використай f-рядок. Передай число <code style="color: #0ea5e9;">7</code>, але застосуй до нього формат доповнення нулями до 5 символів (<code style="color: #0ea5e9;">:05</code>).
        </div>`,
...

      {
        ...
        `,
        desc: `Надрукуй повідомлення про отриманий досвід:<br><br>
        <code style="color: #f59e0b; font-size: 16px;">Отримано: +500 XP</code>
        
        <div class="task-condition">
          <b style="color: #8b5cf6;">Умова:</b> Число <code style="color: #0ea5e9;">500</code> має бути відформатоване з обов'язковим показом знака <code style="color: #0ea5e9;">:+</code>. Не пиши плюс вручну як текст!
        </div>`,
...

      {
        ...
        `,
        desc: `Розпакуй список чисел і виведи їх через вертикальну риску:<br><br>
        <code style="color: #f59e0b; font-size: 16px;">10|20|30</code>
        
        <div class="task-condition">
          <b style="color: #8b5cf6;">Умова:</b> Створи список <code style="color: #0ea5e9;">[10, 20, 30]</code> прямо всередині команди виводу. Розпакуй його за допомогою зірочки <code style="color: #0ea5e9;">*</code> і додай параметр <code style="color: #0ea5e9;">sep="|"</code>.
        </div>`,
...

      {
        ...
        `,
        desc: `Створи фінансовий звіт компанії. Виведи точно такий текст:<br>
<pre style="color: #f59e0b; font-size: 16px;">==== YEARLY REPORT ====
Revenue: 2,500,000 $
Tax: 833,333.33 $
=======================</pre>
        ...
        <div class="task-condition">
          ...
          3) Другий рядок: Текст "Revenue: " та число <code style="color: #0ea5e9;">2500000</code>, відформатоване з комами.<br>
          4) Третій рядок: Текст "Tax: " та результат ділення <code style="color: #0ea5e9;">2500000 / 3</code>, відформатований з комами та 2 знаками після крапки.<br>
...

      {
        ...
        `,
        desc: `Створи фейковий лог помилки:<br>
<pre style="color: #f59e0b; font-size: 16px;">Error in C:\\Windows\\System32
Mem[0x00ff]: 10101010</pre>

        <div class="task-condition">
          <b style="color: #8b5cf6;">Умови:</b><br>
          1) Використай ОДИН <code style="color: #0ea5e9;">print()</code> з двома аргументами і <code style="color: #0ea5e9;">sep="\\n"</code>.<br>
          2) Перший аргумент — це <b>сирий рядок</b> (<code style="color: #0ea5e9;">r"..."</code>), щоб не дублювати слеші.<br>
          3) Другий аргумент — <b>f-рядок</b>.<br>
          4) Число 255 виведи як шістнадцяткове з 4 цифрами (<code style="color: #0ea5e9;">00ff</code>).<br>
          5) Число 170 виведи як двійкове (<code style="color: #0ea5e9;">10101010</code>).
        </div>`,
...

      {
        ...
        `,
        desc: `Згенеруй рядок бази даних:<br><br>
        <code style="color: #f59e0b; font-size: 16px;">ID: 00099 | Score: +500</code>
        
        <div class="task-condition">
          <b style="color: #8b5cf6;">Умова:</b> Використай ОДИН f-рядок. Число <code style="color: #0ea5e9;">99</code> має бути доповнене нулями до 5 символів. Число <code style="color: #0ea5e9;">500</code> має виводитись із обов'язковим знаком плюса.
        </div>`,
      ...
      // ===============================
      {
        ...
        `,
        desc: `Намалюй котика точно так, як показано нижче (зверни увагу на пробіли перед вушками та лапками!):<br>
